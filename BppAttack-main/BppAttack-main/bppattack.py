...
def dump_pic(inputs, origin_label, inputs_bd, perturbed_label):
    ...
    plt.imsave('BppAttack_origin_image.jpg',origin_image)
    plt.imsave('BppAttack_perturbed_image.jpg',perturbed_image)
    plt.figure()
    plt.subplot(1,2,1)
...
def eval(
    ...
    eval_result.append({"clean_acc": acc_clean, "bd_acc": acc_bd, "cross_acc": acc_cross})
    with open(os.path.join(opt.ckpt_folder, "eval_result.pkl"), "wb") as f:
